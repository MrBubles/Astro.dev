 ...
 */
package international.astro.util.font;

import international.astro.util.font.GlyphPage;
...
public class GlyphPageFontRenderer {
    ...
    public int drawString(String text, float x, float y, int color) {
        ...
        this.resetStyles();
        int i = this.renderString(text, x - 2.0f, y - 2.5f, color, false);
    ...
    public int drawStringWidthShadow(String text, float x, float y, int color) {
        GlStateManager.enableAlpha();
        this.resetStyles();
        int i = this.renderString(text, x, y, color, true);
    ...
    private void doDraw(float f, GlyphPage glyphPage) {
        ...
        if (this.strikethroughStyle) {
            ...
            bf.begin(7, DefaultVertexFormats.POSITION);
            bf.pos((double) this.posX, (double) (this.posY + (float) (glyphPage.getMaxFontHeight() / 2)), 0.0).endVertex();
            bf.pos((double) (this.posX + f), (double) (this.posY + (float) (glyphPage.getMaxFontHeight() / 2)), 0.0).endVertex();
            bf.pos((double) (this.posX + f), (double) (this.posY + (float) (glyphPage.getMaxFontHeight() / 2) - 1.0f), 0.0).endVertex();
            bf.pos((double) this.posX, (double) (this.posY + (float) (glyphPage.getMaxFontHeight() / 2) - 1.0f), 0.0).endVertex();
            tes.draw();
            GlStateManager.enableTexture2D();
        }
        if (this.underlineStyle) {
            ...
            bf.pos((double) (this.posX + (float) l), (double) (this.posY + (float) glyphPage.getMaxFontHeight()), 0.0).endVertex();
            bf.pos((double) (this.posX + f), (double) (this.posY + (float) glyphPage.getMaxFontHeight()), 0.0).endVertex();
            bf.pos((double) (this.posX + f), (double) (this.posY + (float) glyphPage.getMaxFontHeight() - 1.0f), 0.0).endVertex();
            bf.pos((double) (this.posX + (float) l), (double) (this.posY + (float) glyphPage.getMaxFontHeight() - 1.0f), 0.0).endVertex();
            tes.draw();
            GlStateManager.enableTexture2D();
        }
        this.posX += f;
